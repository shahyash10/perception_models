"""
python -m launchers.stool run config=apps/plm/configs/stage_2/plm_1b.yaml name=<name> group=a100-comem account=<account> nodes=1 ncpu=10 ngpu=8
"""
...
class StoolRunArgs(StoolCLIArgs):
    ...
    def __post_init__(self) -> None:
        ...
        self.dump_dir = Path(self.root_dump_dir) / f"{self.name}_{timestamp}"
        # set anaconda
