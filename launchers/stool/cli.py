...
def get_root_dump_dir(cluster_type: ClusterType, group: str) -> str:
    ...
    default_dump_dir_map: dict[ClusterType, Path] = {
        ClusterType.AWS_FAIR_A100: Path("/fsx-checkpoints/yashs/plm/"),
    }
...
class StoolRunArgs(StoolCLIArgs):
    ...
    anaconda: str = "perception_models"  # The path to the anaconda environment
    ...
    mem: str = "640GB"  # The amount of memory to allocate
    ...
    reservation: str = ""
    time: int = 4320  # The time limit of the job (in minutes)
    stdout: bool = False
...
class StoolRelaunchArgs(StoolCLIArgs):
    ...
    def _set_job_dir(self, job_dir: str | Path):
        ...
        assert self.job_dir.is_relative_to(
            self.root_dump_dir
...
export TMPDIR="/scratch/slurm_tmpdir/$SLURM_JOB_ID"
export TMP_DIR="/scratch/slurm_tmpdir/$SLURM_JOB_ID"
